...
Please stick to the programming paradigm you feel most comfortable in. However, we tend to prefer a functional style – in fact, our Elixir backend requires it – so if you already have the knowledge or are willing to learn, now is the time to show it!

Also, don't worry about dev tooling and focus on the main problem.
